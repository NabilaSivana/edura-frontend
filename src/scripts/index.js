import '@fortawesome/fontawesome-free/css/all.min.css';import "../styles/style.css";import navbar from "./component/navbar.js";import routes from "./routes/route.js";import UrlParser from "./routes/url-parser.js";import NotFoundPage from "./utils/404.js";import UnauthorizedPage from "./utils/401.js";import ForbiddenPage from "./utils/403.js";import AuthGuard from "./utils/auth-guard.js";const App={isRendering:!1,currentRoute:null,currentContent:null,navigationState:{lastHash:'',lastNavbarState:null,lastSidebarState:null},async renderPage(){if(this.isRendering){return}
