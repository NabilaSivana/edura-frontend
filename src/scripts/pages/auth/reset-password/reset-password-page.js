...
//     // Check requirements
//     const requirements = [
//       { test: password.length >= 8, element: reqLength },
//       { test: /[A-Z]/.test(password), element: reqUppercase },
//       { test: /[a-z]/.test(password), element: reqLowercase },
//       { test: /[0-9]/.test(password), element: reqNumber },
//       { test: /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~`]/.test(password), element: reqSpecial }
//     ];

//     // Update requirement indicators
//     requirements.forEach(req => {
//       const checkIcon = req.element.querySelector('svg');
//       const circle = req.element.querySelector('div');
...
//         req.element.querySelector('span').classList.add('text-green-600', 'dark:text-green-400');
//         req.element.querySelector('span').classList.remove('text-gray-600', 'dark:text-gray-400');
//       } else {
//         circle.classList.add('border-gray-300', 'dark:border-gray-600');
//         circle.classList.remove('border-green-500', 'bg-green-500');
//         checkIcon.classList.add('hidden');
//         req.element.querySelector('span').classList.remove('text-green-600', 'dark:text-green-400');
//         req.element.querySelector('span').classList.add('text-gray-600', 'dark:text-gray-400');
//       }
//     });

//     // Calculate strength score with additional complexity checks
//     score = metRequirements;

//     // Bonus points for complexity
//     if (password.length >= 12) score += 0.5;
//     if (password.length >= 16) score += 0.5;
//     if (/[A-Z].*[A-Z]/.test(password)) score += 0.3; // Multiple uppercase
//     if (/[0-9].*[0-9]/.test(password)) score += 0.3; // Multiple numbers
//     if (/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~`].*[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~`]/.test(password)) score += 0.3; // Multiple special chars

//     // Update strength bar and text
//     const maxScore = 6.4; // Maximum possible score
...
//       strengthText.className = "text-xs font-bold text-gray-500 dark:text-gray-400";
//     } else if (score < 2) {
//       strengthBar.style.width = `${Math.max(percentage, 15)}%`;
//       strengthBar.className = "h-full transition-all duration-300 rounded-full bg-gradient-to-r from-red-500 to-red-600";
//       strengthText.textContent = "Sangat Lemah";
//       strengthText.className = "text-xs font-bold text-red-600 dark:text-red-400";
//     } else if (score < 3) {
//       strengthBar.style.width = `${Math.max(percentage, 30)}%`;
//       strengthBar.className = "h-full transition-all duration-300 rounded-full bg-gradient-to-r from-orange-500 to-red-500";
//       strengthText.textContent = "Lemah";
//       strengthText.className = "text-xs font-bold text-orange-600 dark:text-orange-400";
//     } else if (score < 4) {
//       strengthBar.style.width = `${Math.max(percentage, 50)}%`;
//       strengthBar.className = "h-full transition-all duration-300 rounded-full bg-gradient-to-r from-yellow-500 to-orange-500";
//       strengthText.textContent = "Sedang";
//       strengthText.className = "text-xs font-bold text-yellow-600 dark:text-yellow-400";
//     } else if (score < 5) {
//       strengthBar.style.width = `${Math.max(percentage, 75)}%`;
//       strengthBar.className = "h-full transition-all duration-300 rounded-full bg-gradient-to-r from-blue-500 to-green-500";
//       strengthText.textContent = "Kuat";
//       strengthText.className = "text-xs font-bold text-blue-600 dark:text-blue-400";
//     } else {
//       strengthBar.style.width = "100%";
//       strengthBar.className = "h-full transition-all duration-300 rounded-full bg-gradient-to-r from-green-500 to-emerald-600 shadow-lg";
//       strengthText.textContent = "Sangat Kuat";
//       strengthText.className = "text-xs font-bold text-green-600 dark:text-green-400";
//     }

//     return metRequirements >= 5; // Return true if all basic requirements are met
//   },
...
//       return confirmPassword.length === 0; // Return true if empty (not yet filled)
//     }
//   },
...
//     if (isPasswordStrong && isPasswordMatch && hasPasswords) {
...
//       this.showError("Password tidak memenuhi persyaratan keamanan. Pastikan password mengandung minimal 8 karakter, huruf besar, huruf kecil, angka, dan karakter khusus.");
//       return;
//     }
