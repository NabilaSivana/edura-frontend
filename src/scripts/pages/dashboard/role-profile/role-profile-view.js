...
//         <div class="mb-6">
//           <h2 class="text-xl font-bold dark:text-white mb-2">Lengkapi Profil Anda</h2>
//           <p class="text-sm text-gray-600 dark:text-gray-400">Silakan lengkapi data profil Anda untuk melanjutkan menggunakan aplikasi.</p>
//         </div>
...
//             <span id="submit-text">Simpan Profil</span>
...
//     const teacherFields = `
//       <div class="space-y-1">
//         <label for="nidn" class="${labelClasses}">NIDN</label>
//         <input type="text" id="nidn" name="nidn" class="${inputClasses}" required placeholder="Masukkan NIDN Anda">
//       </div>
...
//       <div class="space-y-1">
//         <label for="fakultas" class="${labelClasses}">Fakultas/Jurusan</label>
//         <input type="text" id="fakultas" name="fakultas" class="${inputClasses}" required placeholder="Masukkan fakultas/Jurusan Anda">
//       </div>

//       <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
//         <div class="space-y-1">
//           <label for="program_studi" class="${labelClasses}">Program Studi</label>
//           <select id="program_studi" name="program_studi" class="${inputClasses}" required>
//             <option value="">-- Pilih Program Studi --</option>
//             ${selectOptions(program_studi)}
//           </select>
//         </div>
//         <div class="space-y-1">
//           <label for="perguruan_tinggi" class="${labelClasses}">Perguruan Tinggi</label>
//           <select id="perguruan_tinggi" name="perguruan_tinggi" class="${inputClasses}" required>
//             <option value="">-- Pilih Perguruan Tinggi --</option>
//             ${selectOptions(perguruan_tinggi)}
//           </select>
//         </div>
